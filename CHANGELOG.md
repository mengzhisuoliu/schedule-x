...
- **docs:** svelte example ([#1318](https://github.com/schedule-x/schedule-x/issues/1318)) ([121d82f](https://github.com/schedule-x/schedule-x/commit/121d82fc95974c4c470a9a32c59f4e3c90942081)), closes [schedule-x/svelte#76](https://github.com/schedule-x/svelte/issues/76)
...
- **website:** consolidate pricing section ([#1323](https://github.com/schedule-x/schedule-x/issues/1323)) ([a194091](https://github.com/schedule-x/schedule-x/commit/a1940918ad3e238544a918693292779a7933c0c3))
...
- **calendar:** event concurrency improvement ([#1295](https://github.com/schedule-x/schedule-x/issues/1295)) ([cbd0b1a](https://github.com/schedule-x/schedule-x/commit/cbd0b1a1f6db9e9d530035970c4c97530fd0dd25))
- **theme-default:** fix z-index in weekly ([#1296](https://github.com/schedule-x/schedule-x/issues/1296)) ([593130c](https://github.com/schedule-x/schedule-x/commit/593130c084c9f6e538ccd622cd0d8422f157d767))
...
- **calendar-controls:** enable updates of resources ([#1280](https://github.com/schedule-x/schedule-x/issues/1280)) ([65a483c](https://github.com/schedule-x/schedule-x/commit/65a483c72a96cb7e569644d45199f0ab1f205b5e))
...
## [3.7.2](https://github.com/schedule-x/schedule-x/compare/v3.7.1...v3.7.2) (2026-01-13)
...
- add exports needed for vertical resource view ([#1273](https://github.com/schedule-x/schedule-x/issues/1273)) ([d7cb9a1](https://github.com/schedule-x/schedule-x/commit/d7cb9a1bd31b301a2eccf3a11f3568d01fbd1ad5))
...
- add discord icon ([#1193](https://github.com/schedule-x/schedule-x/issues/1193)) ([14f68df](https://github.com/schedule-x/schedule-x/commit/14f68df241d19caaef7f94ab3016f39912544a88))
...
- config validation ([#860](https://github.com/schedule-x/schedule-x/issues/860)) ([6e0d5cc](https://github.com/schedule-x/schedule-x/commit/6e0d5cca5c4dfd8676fddde5833dadbdb9a96720))
