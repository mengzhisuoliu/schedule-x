...
| `weekAgendaEvent`           | The component for events used in the week agenda view               | `calendarEvent`                 |
| `monthAgendaDateDots`       | Replaces the date dots in the month agenda view                     | `date`, `jsDate`, `events`      |
